...
from account.serializers import UserRegistrationSerializer, UserProfileSerializer,UserpasswordSerializer,SendPasswordResetEmailSerializer
...
class UserPasswordResetVeiw(APIView):
    renderer_classes=[UserRenderer]
